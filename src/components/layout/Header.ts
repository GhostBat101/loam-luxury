    ...
    <header class="fixed top-0 left-0 w-full z-50 bg-[#f1f5f9]/85 backdrop-blur-md hairline-border-b transition-all duration-300">
      <div class="max-w-[1720px] mx-auto px-6 sm:px-10 lg:px-16 h-20 flex items-center justify-between">
        <div class="flex items-baseline gap-4 group">
          ...
          <span class="font-mono text-[10px] uppercase tracking-[0.24em] text-[#053C6B] font-bold transition-opacity duration-300 group-hover:opacity-80">// LOAM SUBSTRATE</span>
        </div>
        <nav aria-label="Main Navigation" class="hidden lg:flex items-center gap-8 xl:gap-10">
          <a aria-current="page" class="nav-magnetic font-mono text-[11px] uppercase tracking-[0.2em] text-[#071D31] font-bold py-1 hover:text-[#053C6B]" href="#origin">[01_ORIGIN]</a>
          <a class="nav-magnetic font-mono text-[11px] uppercase tracking-[0.2em] text-[#1C3B5E] font-bold hover:text-[#053C6B] py-1" href="#spectrum">[02_SPECTRUM]</a>
          <a class="nav-magnetic font-mono text-[11px] uppercase tracking-[0.2em] text-[#1C3B5E] font-bold hover:text-[#053C6B] py-1" href="#radius">[03_RADIUS]</a>
          <a class="nav-magnetic font-mono text-[11px] uppercase tracking-[0.2em] text-[#1C3B5E] font-bold hover:text-[#053C6B] py-1" href="#allocation">[04_ALLOCATION]</a>
        </nav>
        <div class="flex items-center gap-4 sm:gap-6 lg:gap-8">
          <button aria-pressed="false" class="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.18em] text-[#071D31] px-3 py-1.5 border border-[#285384]/20 hover:border-[#053C6B] bg-white/60 backdrop-blur-sm font-semibold transition-all hover:bg-white/80 focus-visible:outline-none cursor-pointer" id="motion-toggle-btn" title="Toggle animation motion" type="button">
          ...
          <div class="hidden xl:flex items-baseline gap-2 font-mono text-[10px] tracking-widest text-[#1C3B5E]">
            <span class="opacity-80 font-semibold">[COORD]</span>
            <span class="text-[#071D31] font-bold hover:text-[#053C6B] transition-colors cursor-default">36.8433°N / 25.8916°E</span>
          </div>
