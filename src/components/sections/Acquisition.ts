      ...
      <div class="relative z-10 max-w-[1720px] mx-auto">
        <div class="expand-divider w-full flex items-baseline justify-between mb-20 pb-6 hairline-border-b reveal-item">
          <div class="flex items-baseline gap-6 lg:gap-10">
            ...
            <h2 class="font-mono text-xs lg:text-sm uppercase tracking-[0.28em] text-[#053C6B] font-bold m-0" id="heading-allocation">04 · ORDER</h2>
          </div>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div class="lg:col-span-7 space-y-6 reveal-item" style="transition-delay: 150ms;">
            <div class="font-mono text-xs uppercase tracking-widest text-[#053C6B] font-bold">
              FIRST EDITION · SMALL BATCH BOTTLED IN GREECE
            </div>
